...
uint256 hashGenesisBlock("0x00000000019076a2eb93aab80291ceb910999695f0517719e4b6632d75cd8b87");
...
const string strMessageMagic = "LondonGoldCoin Signed Message:\n";
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    // Subsidy is cut in half every 570000 blocks, which will occur approximately every 4 years
    nSubsidy >>= (nHeight / 570000);

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 18000;
static const int64 nTargetSpacing = 6000;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x00000000019076a2eb93aab80291ceb910999695f0517719e4b6632d75cd8b87");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1420845747;
        block.nBits    = 486604799;
        block.nNonce   = 352635848;
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("LondonGoldCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("LondonGoldCoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("LondonGoldCoinMiner started\n");
    ...
    try { loop {
        ...
        printf("Running LondonGoldCoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("LondonGoldCoinMiner terminated\n");
        throw;
    }
}
